...
**IMPORTANT**: The constraints above about files you should NOT create are STRICT. Another directive owns those files. If you create them, you will cause merge conflicts and the mission will fail.
